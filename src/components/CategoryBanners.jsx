...
const CategoryBanners = () => {
  ...
  const exploreRegionsCard = {
    id: 'regions',
    name: 'Explore Crafts by Region',
    image: 'https://images.pexels.com/photos/1080721/pexels-photo-1080721.jpeg?auto=compress&cs=tinysrgb&w=400',
    discount: 'Interactive Map',
  ...
  return (
    <div className="mb-8">
      ...
      {/* Explore Regions Banner */}
      <div className="mb-6">
        <div
          className={`relative overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer bg-gradient-to-br ${exploreRegionsCard.bgColor}`}
          onClick={() => navigate('/regions')}
        >
          <div className="aspect-[3/1] relative">
            <img
              src={exploreRegionsCard.image}
              alt={exploreRegionsCard.name}
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-white text-center">
                ...
                <h3 className="font-bold text-xl md:text-2xl mb-2">
                  {exploreRegionsCard.name}
                </h3>
                <div className="text-sm font-bold bg-white bg-opacity-20 px-3 py-1 rounded-full inline-block">
                  {exploreRegionsCard.discount}
                </div>
              </div>
            </div>
          </div>
